...
export function getProbeRunConfig(overrides: Partial<ProbeRunConfig> = {}): ProbeRunConfig {
  const base: ProbeRunConfig = {
    ...
    requestRateLimit: intEnv("PROBE_REQUESTS_PER_MINUTE", 60),
    requestRateLimitMin: intEnv("PROBE_REQUESTS_PER_MINUTE_MIN", 30),
    requestRateLimitMax: intEnv("PROBE_REQUESTS_PER_MINUTE_MAX", 60),
    maxConcurrency: intEnv("PROBE_MAX_CONCURRENCY", 8),
    maxConcurrencyMin: intEnv("PROBE_MAX_CONCURRENCY_MIN", 4),
    maxConcurrencyMax: intEnv("PROBE_MAX_CONCURRENCY_MAX", 10),
    tokensPerMinuteBudget: intEnv("PROBE_TOKENS_PER_MINUTE_BUDGET", 250000),
    tokensPerMinuteMin: intEnv("PROBE_TOKENS_PER_MINUTE_MIN", 100000),
    tokensPerMinuteMax: intEnv("PROBE_TOKENS_PER_MINUTE_MAX", 300000),
    maxRetries: intEnv("PROBE_MAX_RETRIES", 1),
    singleMaxOutputTokens: intEnv("PROBE_SINGLE_MAX_OUTPUT_TOKENS", 1200),
    batchMaxOutputTokens: intEnv("PROBE_BATCH_MAX_OUTPUT_TOKENS", 5000),
